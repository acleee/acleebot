...
TWITCH_ATLAS_LOGIN = getenv("TWITCH_ATLAS_LOGIN")
TWITCH_ATLAS_BROADCASTER_ID = getenv("TWITCH_ATLAS_BROADCASTER_ID")

TWITCH_BROADCASTERS = {
    TWITCH_USER_LOGIN: TWITCH_BROADCASTER_ID,
    TWITCH_ATLAS_LOGIN: TWITCH_ATLAS_BROADCASTER_ID,
}
...
FOOTY_TEAMS_PRIORITY = {"liverpool": LIVERPOOL_TEAM_ID, "england": ENGLAND_INT_TEAM_ID}
