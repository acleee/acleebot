...
FOOTY_LEAGUE_IDS = {
    ...
    "UEFA EUROPA": UEFA_EUROPA_ID,
    "FA": FA_LEAGUE_ID,
    "BUND": BUND_LEAGUE_ID,
    "LIGA": LIGA_LEAGUE_ID,
    "EUROS": EUROS_LEAGUE_ID,
    "COPA": COPA_LEAGUE_ID,
    "WORLD": WORLDCUP_LEAGUE_ID,
    "MLS": MLS_LEAGUE_ID,
    "FRIENDLIES": FRIENDLIES_LEAGUE_ID,
    "CONCACAF LEAGUE": CONCACAF_LEAGUE_ID,
    "CONCACAF GOLD CUP": CONCACAF_GOLD_CUP_ID,
    "OLYMPICS": OLYMPICS_LEAGUE_ID,
    "CONCACAF CHAMPIONS": CONCACAF_CHAMPIONS_LEAGUE,
    "WORLD CUP": WORLD_CUP_ID,
    "WORLD CUP QUALIFIERS CONCACAF": WC_QUALIFIERS_CONCACAF,
    "WORLD CUP QUALIFIERS EUROPE": WC_QUALIFIERS_EUROPE,
}
