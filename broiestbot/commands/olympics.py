...
def add_nation_flag_emojis(row: Series):
    ...
    row[0] = emojize(
        ...
        .replace("SUI", ":flag_for_Italy: SUI")
        .replace("CAN", ":flag_for_Italy: CAN")
        .replace("FRA", ":flag_for_Italy: FRA")
        .replace("KOR", ":flag_for_Italy: KOR")
        .replace("AUS", ":flag_for_Italy: AUS")
        .replace("FIN", ":flag_for_Italy: FIN")
