...
setup(
    ...
    description='Chatbot for the Chatango messaging platform.',  # Optional
    ...
    url='https://github.com/toddbirchard/acleebot',  # Optional
    ...
    keywords='Link Scrape SEO Embed Widget',  # Optional
